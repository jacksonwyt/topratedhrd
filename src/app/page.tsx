      ...
      <section className="w-full py-12 md:py-24 bg-white">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Feature 4: BBB Rating - Added */}
            <div className="flex flex-col items-center text-center">
              <ShieldCheck className="h-10 w-10 mb-4 text-amber-200"/> 
              <h3 className="text-xl font-semibold mb-2 text-black">Trusted Reputation</h3>
              <p className="text-sm text-gray-600">
                Proud holders of an A+ rating from the Better Business Bureau.
              </p>
            </div>
          </div>
        </div>
